...
for (let i = 0; i < links.length; i++) {
  links[i].addEventListener("click", function() {
    let current = document.getElementsByClassName("active-li");
...
const url = "https://api.sportradar.us/nhl/trial/v5/en/games/2018/REG/schedule.json?api_key=jjxpjasm445fcjwt6cdhtgdw";
